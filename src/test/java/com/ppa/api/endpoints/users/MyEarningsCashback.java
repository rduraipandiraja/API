...
public class MyEarningsCashback extends Restutils {

	/************************************************************** Constructor **********************************************************************/

	public MyEarningsCashback(ExtentTest logger) {
	...
	public static final String ENDPOINTCASHBACK;
	...
	static {
		...
		ENDPOINTCASHBACK	= Utils.getRestApiTestData(2, "cashback");
		
	}
	
	/* getMyEarningsCashbackResponseUserEndPoint */
	public Response getMyEarningsCashbackResponseUserEndPoint(String baseURL, String signUpUserToken, int statusCode) throws InterruptedException, AWTException {
		

		logger.log(LogStatus.INFO, "******* About to get My Earnings Cashback response ******* ..!");
		Log.info("******* About to get My Earnings Cashback response ******* ..!");
		
		// Assigning values
		String completedURL = baseURL+ENDPOINTUSERS+ENDPOINTMYEARNINGS+ENDPOINTCASHBACK;

		// AuthType setup based on conditions
		Response MyEarningsCashbackResponse = getRequestSpecification(completedURL, AUTHORIZATIONKEY, signUpUserToken, ACCEPTKEY, ACCEPTVALUE, statusCode);
		
		logger.log(LogStatus.PASS, "************Successfully got My Earnings Cashback END POINT  response :  " + MyEarningsCashbackResponse.asString());
		Log.info("************Successfully got My Earnings Cashback END POINT  response :  " + MyEarningsCashbackResponse.asString());

		return MyEarningsCashbackResponse;

	}

	/* getMyEarningsCashbackResponseUserEndPoint */
	public Response getMyEarningsCashbackResponseUserEndPoint(String baseURL, int statusCode) throws InterruptedException, AWTException {
		...
		// AuthType setup based on conditions
		Response myEarningsCashbackResponse = getRequestSpecification(completedURL, statusCode);
		
		logger.log(LogStatus.PASS, "************Successfully got My Earnings END POINT  response :  " + myEarningsCashbackResponse.asString());
		Log.info("************Successfully got My Earnings END POINT  response :  " + myEarningsCashbackResponse.asString());
	...
	public Response getMyEarningsCashbackResponseUserEndpoint(String baseURL, String signUpUserToken, String AcceptValue, int statusCode) throws InterruptedException, AWTException {
	...
	/* getMyEarningsCashbackResponseUserEndPoint */
	public Response getMyEarningsCashbackResponseUserEndPoint(String baseURL, String signUpUserToken, String queryParameter, int statusCode) throws InterruptedException, AWTException {
		...
		// Assigning values
		String completedURL = baseURL+ENDPOINTUSERS+ENDPOINTMYEARNINGS+ENDPOINTCASHBACK+queryParameter;
	...
	/* validateMyEarningsCashbackSuccessResponseUserEndPoint */
	public void validateMyEarningsCashbackSuccessResponseUserEndPoint(SoftAssert objSoftAssertion, Response response, String totalrecords, String pagenumber, String pagesize, String dataValue) throws InterruptedException, AWTException {

		logger.log(LogStatus.INFO, "******* About to validate My Earnings cashback response ******* ..!");
		Log.info("******* About to validate My Earnings cashback response ******* ..!");
	...
	public void validateMyEarningsCashbackSuccessResponseUserEndPoint(SoftAssert objSoftAssertion, Response response, String type, String id, String totalCashbackEarned, String paidCashback, String cashbackAvailablePayment, String pendingCashback, String referralCashback, String authCashback, String currency, String typerelationship, String idrelationship, String month, String year, String self) throws InterruptedException, AWTException {
		...
		assertionContainsUsingSubstring(paidCashbackData, paidCashback, objSoftAssertion, response);
		assertionContainsUsingSubstring(cashbackAvailablePaymentData, cashbackAvailablePayment, objSoftAssertion, response);
		assertionContainsUsingSubstring(pendingCashbackData, pendingCashback, objSoftAssertion, response);
		assertionContainsUsingSubstring(referralCashbackData, referralCashback, objSoftAssertion, response);
		assertionContainsUsingSubstring(authCashbackData, authCashback, objSoftAssertion, response);
	...
	/* validateMyEarningsCashbackSuccessResponseUserEndPoint */
	public void validateMyEarningsCashbackSuccessResponseUserEndPoint(SoftAssert objSoftAssertion, Response response, String index, String type, String id, String authorizedReferral, String currency, String data) throws InterruptedException, AWTException {
	...
	/* validateMyEarningsCashbackSuccessResponseUserEndPoint */
	public void validateMyEarningsCashbackSuccessResponseUserEndpoints(SoftAssert objSoftAssertion, Response response, String index, String type, String id, String authorizedReferral, String currency, String typeIncluded, String idIncluded, String month, String year, String self) throws InterruptedException, AWTException {
		...
		assertionContainsUsingSubstring("included.relationships["+index+"].months.data.type", typeIncluded, objSoftAssertion, response);
		assertionContainsUsingSubstring("included.relationships["+index+"].months.data.id", idIncluded, objSoftAssertion, response);
		assertionContainsUsingSubstring("included.relationships["+index+"].months.data.attributes.month", month, objSoftAssertion, response);
		assertionContainsUsingSubstring("included.relationships["+index+"].months.data.attributes.year", year, objSoftAssertion, response);
		assertionContainsUsingSubstring("included.relationships["+index+"].months.data.links.self", self, objSoftAssertion, response);
	...
	public void validateIncludeQueryParameterCountResponseMyEarningsCashbackEndPoint(SoftAssert objSoftAssertion, Response response, int expectedCount) throws InterruptedException, AWTException {
	...
	/* validateMyEarningsCashbackErrorResponseUserEndpoint */
	public void validateMyEarningsCashbackErrorResponseUserEndpoint(SoftAssert objSoftAssertion, Response response, String errorMessage) throws InterruptedException, AWTException {
	...
	/* validateMyEarningsCashbackErrorResponseUserEndpoint */
	public void validateMyEarningsCashbackErrorResponseUserEndpoint(SoftAssert objSoftAssertion, Response response, String errorLinks, String errorStatus, String errorTitle, String errorDetail) throws InterruptedException, AWTException {
	...
	/* validateMyEarningsCashbackErrorResponseUserEndpoint */
	public void validateMyEarningsCashbackErrorResponseUserEndpoint(SoftAssert objSoftAssertion, Response response, String errorStatus, String errorCode, String errorTitle, String errorDetail, String errorParameter) throws InterruptedException, AWTException {
